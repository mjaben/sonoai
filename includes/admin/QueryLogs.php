...
class QueryLogs {
        ...
        if ( isset( $_POST['action'] ) ) {
            ...
            if ( 'delete' === $_POST['action'] && ! empty( $_POST['log_id'] ) && is_array( $_POST['log_id'] ) ) {
                ...
                if ( class_exists( 'SonoAI\AuditLogger' ) ) {
                    AuditLogger::log( 'delete_query_logs', 'Deleted ' . count($ids) . ' query logs.' );
                }
                ...
                if ( class_exists( 'SonoAI\AuditLogger' ) ) {
                    AuditLogger::log( 'clear_all_query_logs', 'Permanently cleared all query logs.' );
                }
    ...
    public function render_page(): void {
        ...
        if ( class_exists( 'SonoAI\AuditLogger' ) ) {
            AuditLogger::log( 'view_query_logs', 'User viewed the Query Logs page.' );
        }
